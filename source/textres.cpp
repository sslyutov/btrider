...
std::map<short, std::string> mapBthMfg = {
		{ 0x0000 , "Ericsson AB"}
		...
		,{ 0x0485 , "SKIDATA AG											"}
		,{ 0x0486 , "DEV TECNOLOGIA INDUSTRIA, COMERCIO E MANUTENCAO DE ENOS"}
		...
		,{ 0x067F , "NETGRID S.N.C.DI BISSOLI MATTEO, CAMPOREALE SIMONE,E F"}
		...
		,{ 0x068C , "Changzhou Sound Dragon Electronics and Acoustics Co."}
		,{ 0x068D , "JetBeep Inc.										"}
		,{ 0x068E , "Razer Inc.											"}
		...
		,{ 0x06C9 , "MYLAPS B.V.										"}
		,{ 0x06CA , "Shenzhen Zhongguang Infotech Technology Development d"}
		,{ 0x06CB , "Dyeware, LLC										"}
		...
		,{ 0x0750 , "Hamilton Professional Services of Canada Incorporate"}
		...
		,{ 0x07F4 , "MEDIRLAB Orvosbiologiai Fejleszto Korlatolt Felelosssg"}
		,{ 0x07F5 , "Byton North America Corporation					"}
		,{ 0x07F6 , "Shenzhen TonliScience and Technology Development Co."}
		...
		,{ 0x0884 , "Controlid Industria, Comercio de Hardware e Servicosngi"}
		,{ 0x0885 , "LEVOLOR INC										"}
		...
		,{ 0x08A3 , "Hoffmann SE										"}
		,{ 0x08A4 , "Realme Chongqing Mobile Telecommunications Corp., Lt"}
		,{ 0x08A5 , "UMEHEAL Ltd										"}
		...
		,{ 0x0959 , "HerdDogg, Inc										"}
		,{ 0x095A , "Selekt Bilgisayar, lletisim Urunleri lnsaat Sanayi veim"}
		...
		,{ 0x0971 , "GA													"}
		,{ 0x0972 , "Closed Joint Stock Company ”Zavod Flometr”(”Zavod FlC)"}
		,{ 0x0973 , "Popit Oy											"}
		,{ 0x0974 , "ABEYE												"}
		...
		,{ 0x09D6 , "EAR TEKNIK ISITME VE ODIOMETRI CIHAZLARI SANAYI VE TAIM"}
		,{ 0x09D7 , "Coyotta											"}
		...
		,{ 0x0A97 , "SensTek											"}
		,{ 0x0A98 , "Foil, Inc.											"}
		,{ 0x0A99 , "Shanghai high - flying electronics technology Co., L"}
		...
		,{ 0x0AC2 , "RealMega Microelectronics technology(Shanghai) Co.Lt"}
		,{ 0x0AC3 , "Kenzen, Inc.										"}
		,{ 0x0AC4 , "CODIUM												"}
		...
		,{ 0x0B66 , "MITSUBISHI ELECTRIC AUTOMATION(THAILAND) COMPANY LIM"}
		...
		,{ 0x0B88 , "Muguang(Guangdong) Intelligent Lighting Technology C"}
		,{ 0x0B89 , "Rotronic AG										"}
		...
		,{ 0x0B9A , "Beijing Wisepool Infinite Intelligence Technology Co"}
		,{ 0x0B9B , "GISMAN												"}
		,{ 0x0B9C , "Komatsu Ltd.										"}
